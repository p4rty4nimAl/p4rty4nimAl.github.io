  ...
  xhr.onreadystatechange = () => {
    if (xhr.readyState === 4 && xhr.status === 200) {
      ...
      for (let i = 0; i < responseJSON.players.sample.length; i++) {
        ...
        document.getElementById("playerList").innerHTML = document.getElementById("playerList").innerHTML + "<a href=\"https://namemc.com/profile/" + responseJSON.players.sample[i].name + "\">" + responseJSON.players.sample[i].name +"</a><br />";
      }
    }
  }
}
